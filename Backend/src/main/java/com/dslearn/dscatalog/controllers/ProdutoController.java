...
public class ProdutoController {
	...
	public ResponseEntity<Page<ProdutoDTO>> findAll(@RequestParam(value = "page", defaultValue = "0") Integer page,
		...
		Page<ProdutoDTO> lista = service.findAllPaged(pageRequest);
	...
	@PostMapping
	public ResponseEntity<ProdutoDTO> insert(@RequestBody ProdutoDTO categoriaDTO) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ProdutoDTO> update(@PathVariable Long id, @RequestBody ProdutoDTO categoriaDTO) {
